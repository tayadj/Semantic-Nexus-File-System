...
engine = core.Engine()
engine.vectorizer = torch.load(os.path.dirname(__file__) + "/storage/models/vectorizer_T34001.pth", weights_only = False)
engine.sentifier = torch.load(os.path.dirname(__file__) + "/storage/models/sentifier_P4368768_E10.pth", weights_only = False)
engine.entifier = torch.load(os.path.dirname(__file__) + "/storage/models/entifier_P4373120_E10.pth", weights_only = False)
